...
# ``jeanne_ado_mlops_dab/databricks-resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-jeanne-ado-mlops-dab-experiment",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-jeanne-ado-mlops-dab-model", label="Model Name"
)
