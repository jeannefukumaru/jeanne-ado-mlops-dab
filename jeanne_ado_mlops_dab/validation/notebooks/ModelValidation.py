...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``jeanne_ado_mlops_dab/databricks-resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in jeanne-ado-mlops-dab/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in jeanne-ado-mlops-dab/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-jeanne-ado-mlops-dab-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-jeanne-ado-mlops-dab-model", "Model Name")
