...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/jeanne-ado-mlops-dab-tests-ci.yml)
...
* [Staging workspace registered model](https://adb-4301376284584187.7.azuredatabricks.net#mlflow/models/staging-jeanne-ado-mlops-dab-model)
* [Prod workspace registered model](https://adb-3011150083119087.7.azuredatabricks.net#mlflow/models/prod-jeanne-ado-mlops-dab-model)
