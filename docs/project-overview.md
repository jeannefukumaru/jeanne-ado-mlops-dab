...
```
jeanne-ado-mlops-dab        <- Root directory. Both monorepo and polyrepo are supported.
│
├── jeanne_ado_mlops_dab       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
